define(function (require, exports, module) {
  ...
  config.simple = {
    ...
    toolbars: [
      ['FullScreen', 'Undo', 'Bold', 'ForeColor', 'FontSize', 'Italic', 'StrikeThrough', 'Link', 'Emotion', 'InsertImage', 'Attachment', 'InsertVideo', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'ClearDoc', 'InsertTable', 'DeleteTable', 'Source']
    ],
    enterTag: 'p',
